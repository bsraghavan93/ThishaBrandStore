    ...
    >
      ...
      >
        ...
        <Link
          ...
          style={{ backgroundImage: `linear-gradient(90deg, ${ACCENT}, #e91e8c, ${ACCENT})`, backgroundSize: '200% auto' }}
        >
          Shop This Edit →
        </Link>
      </div>
...
export default function TrendsCollectionsPage() {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="px-6 py-16" style={{ background: 'linear-gradient(120deg, #fbe1ec, #fff5f9)' }}>
